...
function heatColor(value, max) {
  if (!value || value <= 0) return "#1D2228";
...
function SummaryCell({ label, value, sub, accent }) {
  return (
    <div style={styles.summaryCell}>
      ...
      <div style={{ ...styles.summaryValue, color: accent || "#E8EAED" }}>{value}</div>
              ...
              cell ? (
                <button
                  ...
                  style={{
                    ...
                    border: cell.isToday ? "1px solid #E8EAED" : selectedDate === cell.dateStr ? "1px solid #2FB8A6" : "1px solid transparent",
                  }}
                >
      ...
      <div style={styles.brandTabs}>
        {BRANDS.map((b) => (
          <button
            ...
            style={{
              ...styles.brandTab,
              borderColor: brand === b ? BRAND_COLOR[b] : "#2B323A",
              color: brand === b ? BRAND_COLOR[b] : "#8A93A0",
            }}
          >
            {BRAND_LABEL[b]}
          </button>
...
const styles = {
  ...
  loading: { color: "#8A93A0", fontFamily: "'JetBrains Mono', monospace", padding: "40px 0" },
  ...
  landingBody: { fontSize: 13, color: "#8A93A0", lineHeight: 1.5 },
  ...
  gateSubtitle: { fontSize: 13, color: "#8A93A0", marginBottom: 6 },
  gateInput: {
    background: "#14181C",
    border: "1px solid #2B323A",
    color: "#E8EAED",
  ...
  rangeBtnActive: { color: "#E8EAED", borderColor: "#E2572B" },
  refreshBtn: {
    background: "transparent",
    border: "1px solid #2B323A",
    color: "#8A93A0",
  ...
  summaryCell: { background: "#1D2228", border: "1px solid #2B323A", borderRadius: 10, padding: "14px 16px" },
  summaryLabel: { fontSize: 11, color: "#8A93A0", letterSpacing: "0.05em", marginBottom: 6, textTransform: "uppercase" },
  summaryValue: { fontFamily: "'JetBrains Mono', monospace", fontSize: 22, fontWeight: 700 },
  summarySub: { fontFamily: "'JetBrains Mono', monospace", fontSize: 12, color: "#8A93A0", marginTop: 2 },
  ...
  docketPerf: {
    ...
    right: 0,
    height: 3,
    backgroundImage: "repeating-linear-gradient(90deg, #14181C 0 6px, transparent 6px 10px)",
  },
  ...
  docketCount: { fontSize: 11, color: "#8A93A0" },
  docketValue: { fontFamily: "'JetBrains Mono', monospace", fontSize: 26, fontWeight: 700, marginTop: 10, color: "#E2572B" },
  gaugeTrack: { height: 4, background: "#14181C", borderRadius: 2, marginTop: 10, overflow: "hidden" },
  gaugeFill: { height: "100%", background: "linear-gradient(90deg, #C9A227, #E2572B)" },
  docketMeta: { display: "flex", gap: 6, fontSize: 12, color: "#8A93A0", marginTop: 8, fontFamily: "'JetBrains Mono', monospace" },
  brandRow: { display: "flex", flexDirection: "column", gap: 5, marginTop: 12, borderTop: "1px solid #2B323A", paddingTop: 10 },
  ...
  brandChipLabel: { color: "#8A93A0", flex: 1 },
  brandChipValue: { fontFamily: "'JetBrains Mono', monospace", color: "#E8EAED" },
  docketHint: { fontSize: 11, color: "#4A525C", marginTop: 12 },
  detailHeadRow: { display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 12, marginBottom: 18 },
  calendarPanel: { background: "#1D2228", border: "1px solid #2B323A", borderRadius: 10, padding: 16 },
  ...
  calWeekday: { textAlign: "center", fontSize: 10.5, color: "#4A525C", fontFamily: "'JetBrains Mono', monospace" },
  ...
  calDayNum: { fontSize: 11, color: "#E8EAED", fontFamily: "'JetBrains Mono', monospace" },
  calDayVal: { fontSize: 9.5, color: "#E8EAED", fontFamily: "'JetBrains Mono', monospace", marginTop: 2 },
  entryDateBanner: {
    fontFamily: "'JetBrains Mono', monospace",
    fontSize: 13,
    color: "#8A93A0",
  ...
  dayPanel: { marginTop: 16, background: "#1D2228", border: "1px solid #2B323A", borderRadius: 10, padding: 14 },
  ...
  itemUnit: { fontSize: 11, color: "#8A93A0", fontFamily: "'JetBrains Mono', monospace" },
  qtyInput: {
    background: "#14181C",
    border: "1px solid #2B323A",
    color: "#E8EAED",
  ...
  entryTotal: { fontSize: 13, color: "#8A93A0", fontFamily: "'JetBrains Mono', monospace" },
  submitBtn: {
    background: "#E2572B",
    border: "none",
    color: "#14181C",
  ...
  todayLog: { marginTop: 26, borderTop: "1px solid #2B323A", paddingTop: 14 },
  todayLogHead: { fontSize: 11, color: "#8A93A0", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 8 },
  todayLogRow: {
    display: "grid",
  ...
  todayLogItem: { color: "#E8EAED" },
  todayLogQty: { fontFamily: "'JetBrains Mono', monospace", color: "#8A93A0", textAlign: "right" },
  ...
  panel: { background: "#1D2228", border: "1px solid #2B323A", borderRadius: 10, padding: 18 },
  panelTitle: {
    fontFamily: "'Oswald', sans-serif",
    fontSize: 15,
    textTransform: "uppercase",
  ...
  revealBtn: { background: "none", border: "none", color: "#8A93A0", cursor: "pointer", fontSize: 11 },
  mutedNote: { color: "#8A93A0", fontSize: 12, fontStyle: "italic" },
  ...
  itemEditName: { background: "transparent", border: "none", color: "#E8EAED", fontSize: 13 },
  itemEditUnit: { background: "#1D2228", border: "1px solid #2B323A", color: "#E8EAED", borderRadius: 5, fontSize: 12, padding: "5px" },
  itemEditPrice: {
    background: "#1D2228",
    border: "1px solid #2B323A",
    color: "#E8EAED",
  ...
  emptyBody: { color: "#8A93A0", fontSize: 13 },
  footer: { marginTop: 40, fontSize: 11, color: "#4A525C", textAlign: "center" },
};
